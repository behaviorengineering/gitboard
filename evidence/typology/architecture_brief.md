...
flowchart LR
  ...
  slice_llm["llm"]
  slice_git_adapters["git-adapters"]
  ...
  slice_dashboard -->|reads| slice_git_adapters
  slice_llm -->|reads| lib_config
  slice_git_adapters -->|reads| slice_board
  slice_git_adapters -->|reads| slice_cliexec
  slice_git_adapters -->|reads| lib_config
  slice_syncproj -->|reads| lib_config
  slice_syncproj -->|reads| slice_git_adapters
  ...
  slice_gitboard -->|reads| slice_git_adapters
  ...
  slice_pruneagent -->|reads| slice_git_adapters
...
| `git-adapters` | Provides clients for interacting with remote Git forge APIs like GitHub and GitLab. |  |
...
| `dashboard` | `git-adapters` | reads |
| `llm` | `config` | reads |
| `git-adapters` | `board` | reads |
| `git-adapters` | `cliexec` | reads |
| `git-adapters` | `config` | reads |
| `syncproj` | `config` | reads |
| `syncproj` | `git-adapters` | reads |
| `triage` | `config` | reads |
| `triage` | `llm` | reads |
